...
module.exports = function(grunt) {
	...
	grunt.registerMultiTask('webfont', 'Compile separate SVG files to webfont', function() {
		...
		var o = {
			...
			htmlDemoName: options.htmlDemoName,
		...
		function generateStylesheet(done) {
			...
			var cssFile = path.join(o.destCss, cssFilePrefix + o.cssName + '.' + o.stylesheet);
		...
		function generateDemoHtml(done) {
			...
			var demoFile = path.join(o.destHtml, o.htmlDemoName + '.html');
